...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>ContBook<span>]</span></a></div>
        ...
        <div class="br-sideleft-menu">
            <a href="index.html" class="br-menu-link active">
                <div class="br-menu-item">
                    ...
                    <span class="menu-item-label" id="btn_menu_users">Usuarios</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            ...
            <a href="card-dashboard.html" class="br-menu-link">
                <div class="br-menu-item">
                    ...
                    <span class="menu-item-label">Provedores</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            ...
                            <li><a href="" onclick="event.preventDefault();
                                    ...
                                    <i class="icon ion-power"></i>salir
                                </a>
